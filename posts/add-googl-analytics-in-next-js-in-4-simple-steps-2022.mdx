...
date: Jun 29, 2022
description: Are you using Next JS on your website and want to add Google Analytics? In this blog post, we'll show you how to do it in just a few simple steps.
...
### 2.4 Tracking Form Submissions, Button Clicks, etc with Google Analytics Events
