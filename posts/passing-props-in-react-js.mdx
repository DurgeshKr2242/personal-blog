...
In this example, the parent component `MainList` contains the child component `ListItem`. We will look at how can we pass data as props from parent component to child component:
...
And there you have it, we just made a change in the parent component from the child component.
